...
public class NaturalPersonBeneficiary {
    ...
    /**
     * @param fiscalCode1 the fiscalCode1 to set
     */
    ...
    /**
     * @param fiscalCode2 the fiscalCode2 to set
     */
    ...
    /**
     * @param fiscalCode3 the fiscalCode3 to set
     */
    ...
    /**
     * @param fiscalCode4 the fiscalCode4 to set
     */
    ...
    /**
     * @param fiscalCode5 the fiscalCode5 to set
     */
